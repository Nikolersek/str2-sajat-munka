...
*/
const checkValues = (array) => array.map(row => (row[0] === row[1] && row[1] === row[2]) && row[0] != null)
    .indexOf(true) !== -1;
    /*
...
*/
const checkWinner = () => {
    //console.log(matrix ,checkColumnValues(), checkDiagonalValues());
